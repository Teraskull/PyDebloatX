...
class Ui_MainWindow(QMainWindow):
    ...
    def retranslateUi(self):
        ...
        self.checkBox.setToolTip('View 3D models and animations in real-time.')
        self.checkBox_2.setToolTip('A combination of alarm clock, world clock, timer, and stopwatch.')
        self.checkBox_3.setToolTip('A calculator that includes standard, scientific, and programmer modes, as well as a unit converter.')
        self.checkBox_4.setToolTip('Stay up to date with email and schedule managing.')
        self.checkBox_5.setToolTip('Point and shoot to take pictures on Windows 10.')
        self.checkBox_6.setToolTip('Provide a way to ask a question and get recommended solutions or contact assisted support.')
        self.checkBox_7.setToolTip('Provide users with information about operating system features.')
        ...
        self.checkBox_22.setToolTip('Unified storefront for apps, video content, and ebooks.')
